...
public class DungeonLevelSO : ScriptableObject
{
    ...
    #region Tooltip
    [Space(10)]
    [Header("Populate the list with the room templates that you want to be part of the level. You need to ensure that room templates are included for all room node types that are specified in the Room Node Graphs for the level.")]
    #endregion Tooltip
    ...
    private  void OnValidate()
    {
        ...
        foreach (RoomTemplateSO roomTemplateSO in roomTemplateList)
        {
            ...
            if(roomTemplateSO.roomNodeType.isEnterance) { isEnterance = true; }
        }
        ...
        {
            Debug.Log("In " + this.name.ToString() + " : No Enterance Corridor Room Type Specified");
        }
        ...
        foreach (RoomNodeGraphSO roomNodeGraph in roomNodeGraphList)
        {
            ...
            // Loop through all nodes in the nodegraph
            foreach (RoomNodeSO roomNodeSO in roomNodeGraph.roomNodeList)
            {
                ...
                if (roomNodeSO.roomNodeType.isEnterance || roomNodeSO.roomNodeType.isCorridorEW ||
